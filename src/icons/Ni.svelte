...
>
  <defs>
    ...
    <mask id="NiSvelteFlagIconRound{id}">
      <rect width="100%" height="100%" fill="black" />
      <circle r="50%" cx="50%" cy="50%" fill="white" />
    </mask>
  </defs>
  <g mask="{ round ? 'url(#NiSvelteFlagIconRound' + id + ')' : '' }">
    ...
    />
    <g clip-path="url(#c{id})" transform="translate(-170.7) scale(.85333)">
      <path
        fill="#fff"
...
>
  ...
  <g mask="{ round ? 'url(#NiSvelteFlagIconRound' + id + ')' : '' }">
    ...
    />
    <g clip-path="url(#ni-c{id})" transform="matrix(.8 0 0 .8 -80 0)">
      <path
        fill="#fff"
        d="M500 226.4l-31.5 54.5-15.4 26.7h93.8l-14.7-25.4-32.2-55.8z"
      />

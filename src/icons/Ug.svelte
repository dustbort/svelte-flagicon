...
>
  <defs>
    ...
    <mask id="UgSvelteFlagIconRound{id}">
      <rect width="100%" height="100%" fill="black" />
      <circle r="50%" cx="50%" cy="50%" fill="white" />
    </mask>
  </defs>
  <g mask="{ round ? 'url(#UgSvelteFlagIconRound' + id + ')' : '' }">
    <g clip-path="url(#a{id})" transform="translate(-128) scale(1.0321)">
...
>
  ...
  <g mask="{ round ? 'url(#UgSvelteFlagIconRound' + id + ')' : '' }">
    <g clip-path="url(#ug-a{id})" transform="translate(80) scale(.9375)">
